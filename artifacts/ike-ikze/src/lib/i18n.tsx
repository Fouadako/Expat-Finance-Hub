...
export const translations: Translations = {
  ...
  ru: {
    ...
    'compare.eligible.both': 'Любое лицо с номером PESEL',
    'compare.early': 'Штраф за досрочный вывод',
    'compare.early.ike': '19% налог на прирост капитала только на прибыль',
    ...
    'faq.a1': 'Да! Любое лицо с номером PESEL может открыть счета IKE и IKZE, включая иностранных резидентов с действующим видом на жительство. Польское гражданство не требуется.',
    ...
    'faq.a4': 'Счета IKE и IKZE наследуемы. Назначенные вами бенефициары (или законные наследники) получат баланс счета. Точный налоговый режим для бенефициаров зависит от их родственных отношений с вами и польского наследственного права.',
    'faq.q5': 'Можно ли вывести деньги до достижения пенсионного возраста?',
    'faq.a5': 'Да, но со штрафами. Для IKE досрочный вывод (до 60 лет) активирует 19% налог на прирост капитала только на прибыль — основной капитал не затрагивается. Для IKZE досрочная полная ликвидация добавляет всю сумму (взносы + доход) к налогооблагаемому доходу по прогрессивной ставке. Лучше держать средства до пенсионного возраста.',
  ...
  ua: {
    ...
    'compare.eligible.both': 'Будь-яка особа з номером PESEL',
    'compare.early': 'Штраф за дострокове виведення',
    'compare.early.ike': '19% податок на приріст капіталу тільки на прибуток',
    ...
    'faq.a1': 'Так! Будь-яка особа з номером PESEL може відкрити рахунки IKE і IKZE, включаючи іноземних резидентів з дійсним дозволом на проживання. Польське громадянство не потрібне.',
    ...
    'faq.a4': 'Рахунки IKE і IKZE успадковуються. Призначені вами бенефіціари (або законні спадкоємці) отримають баланс рахунку. Точний податковий режим для бенефіціарів залежить від їхніх родинних стосунків з вами та польського спадкового права.',
    'faq.q5': 'Чи можна вивести кошти до досягнення пенсійного віку?',
    'faq.a5': 'Так, але зі штрафами. Для IKE дострокове виведення (до 60 років) активує 19% податок на приріст капіталу тільки на прибуток — основний капітал не зачіпається. Для IKZE дострокова повна ліквідація додає всю суму (внески + дохід) до оподатковуваного доходу за прогресивною ставкою. Краще тримати кошти до пенсійного віку.',
